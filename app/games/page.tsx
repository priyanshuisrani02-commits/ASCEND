    ...
    <div className="min-h-screen bg-[#090a0f] text-slate-100 flex flex-col justify-between">
      ...
      <main className="flex-1 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 w-full">
        ...
        <div className="mb-10">
          ...
          <h1 className="text-4xl sm:text-5xl font-black text-white">GAMES DIRECTORY</h1>
          <p className="text-sm text-slate-400 mt-2 max-w-2xl">
            Explore supported competitive titles, discover achievement challenges, and check top player benchmarks.
          </p>
        </div>
        ...
        {filteredGames.length > 0 ? (
          ...
          <div className="glass-panel p-12 text-center rounded-3xl border border-slate-800 my-12">
            <Gamepad2 className="w-12 h-12 text-slate-600 mx-auto mb-3" />
            <h3 className="text-lg font-bold text-slate-300">NO GAMES FOUND</h3>
            <p className="text-xs text-slate-500 mt-1">Try adjusting your search keywords or genre filter.</p>
          </div>
        )}
